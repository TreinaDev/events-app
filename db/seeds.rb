...
FactoryBot.create(:ticket_batch, name: 'Primeiro Lote - Inteira', tickets_limit: 10, event: javascript_event, start_date: 1.weeks.ago, end_date: 1.week.from_now, discount_option: :no_discount)
...
FactoryBot.create(:ticket_batch, name: 'Primeiro Lote - Inteira', tickets_limit: 10, event: full_stack_conf_event, start_date: 4.weeks.ago, end_date: 3.weeks.ago, discount_option: :no_discount)
