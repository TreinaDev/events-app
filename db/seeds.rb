...
ruby_event = FactoryBot.create(:event,
  ...
  event_type: :online,
  event_place: FactoryBot.create(:event_place, user: joao_user),
...
javascript_event = FactoryBot.create(:event,
  name: 'Conferencia JS',
  event_type: :inperson,
  event_place: FactoryBot.create(:event_place, name: 'Salão dos Devs', user: joao_user, street: 'Av. Jose de Alencar', number: '180'),
...
tropical_event = FactoryBot.create(:event,
  ...
  event_type: :hybrid,
  event_place: FactoryBot.create(:event_place, name: 'Teatro Renaissance', user: joao_user, street: 'Av. Paulista', number: '1000'),
  participants_limit: 30,
  url: 'www.evento.com',
  status: :published,
  user: joao_user,
...
ruby_summit_event = FactoryBot.create(:event,
  ...
  event_type: :inperson,
  event_place: FactoryBot.create(:event_place, name: 'Teatro Renaissance', user: maria_user, street: 'Av. Paulista', number: '1000'),
  participants_limit: 30,
